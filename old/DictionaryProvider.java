 ...
 */
public class DictionaryProvider extends ContentProvider {	//TODO
    String TAG = "DictionaryProvider";

    public static String AUTHORITY = "com.timkonieczny.yuome.DictionaryProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/dictionary");

    // MIME types used for searching words or looking up a single definition
    public static final String WORDS_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.example.android.searchabledict";
